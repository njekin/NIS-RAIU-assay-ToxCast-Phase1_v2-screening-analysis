...
Main R functions written in this analysis were gathered as an R package `ToxPlot`, to install or view the most up-to-date version please go to this [github link](https://github.com/njekin/ToxPlot-R-Package).  
